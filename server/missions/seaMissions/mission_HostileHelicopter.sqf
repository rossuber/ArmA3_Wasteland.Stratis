...
_setupObjects =
{
	_missionPos = [ 7000 + ( 600 - ( random 1200 ) ), 7000 + ( 600 - ( random 1200 ) ), 300 ];
	...
	{
		_waypoint = _aiGroup addWaypoint [getMarkerPos _x, 0];
	...
	} forEach ( [ "SunkenMission_0", "SunkenMission_3", "SunkenMission_4", "SunkenMission_7", "town_14" ] call BIS_fnc_arrayShuffle );
	...
	_missionHintText = format ["An armed <t color='%2'>%1</t> is patrolling Sealand. Intercept it and recover its cargo!", _vehicleName, seaMissionColor];
